...
class SchemaDefinitionWrapper {
    ...
    public SchemaDefinitionWrapper(Definition definition, String schemaURL) {
        ...
        loadSchemaTypes(new UrlSchemaLoader(schemaURL), null);
    }

    public SchemaDefinitionWrapper(Definition definition, String schemaURL, String xml) {
        this.definition = definition;
        loadSchemaTypes(new UrlSchemaLoader(schemaURL), xml);
    }
    ...
    public void loadSchemaTypes(DefinitionLoader loader, String xml) {
        schemaTypes = SchemaUtils.loadSchemaTypes(loader.getBaseURI(), loader, xml);

...
public class WsdlUtils {
    ...
    public static Part[] getInputParts(BindingOperation operation) {
        ...
        if (msg != null) {
            ...
            if (soapBody == null || soapBody.getParts() == null) {
                SOAP12Body soap12Body = WsdlUtils.getExtensiblityElement(operation.getBindingInput().getExtensibilityElements(),
                    SOAP12Body.class);
    ...
    public static Part[] getFaultParts(BindingOperation bindingOperation, String faultName) throws Exception {
        ...
        if (soapFault != null && soapFault.getName() != null) {
            ...
            SOAP12Fault soap12Fault = WsdlUtils
                .getExtensiblityElement(bindingFault.getExtensibilityElements(), SOAP12Fault.class);
    ...
    public static SoapVersion getSoapVersion(Binding binding) {
        ...
        if (soapBinding != null) {
            if ((soapBinding.getTransportURI().startsWith(Constants.SOAP_HTTP_TRANSPORT) || soapBinding.getTransportURI()
                .startsWith(Constants.SOAP_MICROSOFT_TCP))) {
    ...
    public static boolean isSoapBinding(Binding binding) {
        if (getSoapVersion(binding) == null) {
            return false;
        } else {
            return true;
        }

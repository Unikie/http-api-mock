...
public class SchemaUtils {
    ...
    public static SchemaTypeSystem loadSchemaTypes(String wsdlUrl, SchemaLoader loader, String xml) {
        try {
            log.debug("Loading schema types from [" + wsdlUrl + "]");
            ArrayList<XmlObject> schemas = new ArrayList<XmlObject>(getSchemas(wsdlUrl, loader, xml).values());
    ...
    public static Map<String, XmlObject> getSchemas(String wsdlUrl, SchemaLoader loader, String xml) {
        Map<String, XmlObject> result = new HashMap<String, XmlObject>();
        getSchemas(wsdlUrl, result, loader, null, xml);
        return result;
    }
     ...
     * specified wsdlUrl
     */
    public static void getSchemas(String wsdlUrl, Map<String, XmlObject> existing, SchemaLoader loader, String tns, String xml) {

...
public class OperationHavingDefaultResponseEqualTo extends ArgumentMatcher<WebserviceOperation> {
    ...
    public OperationHavingDefaultResponseEqualTo(String defaultResponse) {
        super();
